...
| SW5 | M1/M2 | 最小多源候选 | S4a shared encoder + separate student/professional heads | 同 SW1 | 同 SW1 + 对 SW1 paired delta | MUST | DONE | 16/16 folds、622 segments、seed 20260805、fatal=0；LQ/EXP r=.6039/.5220，对 S0 delta=-.0048/-.0136，正向折=7/16、9/16，paired fold CI 均跨 0；MAE=.3879/.3425，仅小幅改善且 CI 跨 0。当前单 seed 不通过 quality gate。 |
