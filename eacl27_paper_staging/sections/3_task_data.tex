...
The retained rubric specifies integer anchors $\{0,1,2,3\}$ and verbal criteria; half-point values arise only after averaging individual ratings. Appendix~A gives the criteria, Appendix~B reports audit details, and Appendix~C illustrates two observed professional-comment cases.
